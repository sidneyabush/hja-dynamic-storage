# Summarize metric and source-data availability across analysis sites.
# Inputs: DISCHARGE_DIR/HF00402_v14.csv; EC_DIR/CF01201_v3.txt; OUT_MET_SUPPORT_DIR/daily_water_balance_et_hamon_zhang_coeff_interp.csv; OUT_MET_SUPPORT_DIR/watersheds_met_q.csv; OUT_MET_ECO_DIR/stream_thermal_lowflow_metrics_annual.csv; STREAM_TEMP_DIR/HT00451_v10.txt.
# Author: Sidney Bush
# Date: 2026-01-30
...
# Analysis-site metadata in standardized site codes
isotope_sites <- c(
...
# Load discharge data for streamflow date ranges
discharge <- read_csv(
...
if (file.exists(wb_file)) {
  ...
  wb_ranges <- tibble(site = character())
}
